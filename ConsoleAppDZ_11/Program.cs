namespace ConsoleAppDz_11
{
    public static class NumberFibExtensions
    {
        public static bool Fibon(this int input)
        {
            int a = 0, b = 1, c;
            while (b < input)
            {
            ...
            do
            {
                ...
                switch (selection)
                {
                    case 1:
                        ...
                        {
                            Console.WriteLine("The number is not a Fibonacci number.");
                        }
                    ...
                    case 2:
                        ...
                        int numWords = text.Words();
                        Console.WriteLine("The number of words : " + numWords);
                        break;
                    ...
                    case 6:
                        ...
                        {
                            int maxTemp = r.Next(15, 40);
                            int minTemp = r.Next(-5, 15);
                            temperatures[i] = new DailyTemperature() { MaxT = maxTemp, MinT = minTemp };
                            Console.WriteLine($"Day {i + 1}: Min Temperature: {minTemp}, Max Temperature: {maxTemp}");
                        }

                        int dayWithMaxDiff = Array.IndexOf(temperatures, temperatures.OrderByDescending(t => t.MaxT - t.MinT).First());
                        Console.WriteLine($"Day with the highest temperature difference: {dayWithMaxDiff + 1}");
                        break;
